...
public class TeamMenuApp {
	...
	private static Team createNewTeam() {
		System.out.println("Enter name of team to create: ");
	...
	private static void addPlayerToTeam() {
		printTeamNames();
		System.out.println("Enter name of team to add player to: ");
	...
	private static void removePlayerFromTeam() {
		printTeamNames();
		System.out.println("Enter name of team to remove player from: ");
		String teamName = scanner.next();
		try {
			Team foundTeam = findTeamByName(teamName);
			foundTeam.describe();
	...
	private static void describeTeam() {
		printTeamNames();
		System.out.println("Enter name of team to describe: ");
		String teamName = scanner.next();
		try {
			Team foundTeam = findTeamByName(teamName);
			foundTeam.describe();
