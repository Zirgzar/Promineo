...
public class MenuInput {
	...
	public static void main(String[] args) {
		...
		List<IceCreamOrder> totalOrder = new ArrayList<IceCreamOrder>();
		...
		while (!complete) {
			...
			totalOrder.add(userOrder);
			
			System.out.println("Would you like another order? 1 = YES, 2 = NO");
		...
		for (IceCreamOrder order : totalOrder) {
			order.describe();
		}
	} // end of main
